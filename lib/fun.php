...
function createPassword($password)
{
    ...
    return md5(md5($password) . 'MGALLERY');
}
...
function imgUpload($file)
{
    ...
    //url地址
    $imgUrl = 'http://localhost/mgallery' . $uploadUrl . $fileDir . $img;
    //操作失败 查看上传目录的权限
